...
REGIONAL_PROFILES: dict[str, dict[str, Any]] = {
    "bangalore": {
        ...
        "communication_style": (
            ...
            "or explicitly asks you to speak in Kannada. Use 'saar', 'ji' respectfully."
        ),
    },
    "delhi": {
        "city_aliases": [
    ...
    "chennai": {
        ...
        "busy_response": "Koi baat nahi ji, aapka time le liya. Dhanyavaad!",
        "communication_style": (
            "Always start in Hindi. ONLY switch to Tamil if the store person speaks in Tamil. "
    ...
    "hyderabad": {
        ...
        "communication_style": (
            "Speak in Hindi by default. ONLY switch to Telugu if the store person speaks Telugu."
        ),
    },
    "kolkata": {
        "city_aliases": [
        ...
        "busy_response": "Koi baat nahi ji, aapka time le liya. Dhanyavaad!",
        "communication_style": (
            "Always start in Hindi. ONLY switch to Bengali if the store person prefers it. "
